        ...
        <div className="w-full">
          ...
          <div className="p-4 border border-slate-300 rounded-md mt-4">
            <div className="flex justify-between">
              <h1 className="text-3xl text-teal-950 font-bold mb-2">
                Rs 42,999
              </h1>
              <h5>
                <FavoriteBorder className="mr-2 text-teal-950" />
                <Share className="text-teal-950" />
              </h5>
            </div>
            <h1 className="mt-2 mb-2 text-lg font-bold text-teal-950">
              Google pixel 6A/6pro/8pro{' '}
            </h1>
            <div className="flex justify-between">
          ...
          <div className="border p-4 mt-4 rounded-lg shadow-md bg-white">
            <h1 className="text-teal-950 text-xl mb-4 font-bold">
              Description
            </h1>
            ...
            <p className="mt-1 text-teal-950 mb-4">
              <span className="text-teal-950 font-semibold">Address:</span>{' '}
              Sultan mobile center Shop No 36 kachari road Multan
            </p>
            <p className="mt-1 text-teal-950 mb-4">
              “Google Pixel original USA stock available, all models PTA
              approved and non-PTA available.
            </p>
            <p className="mt-1 text-teal-950 ">
              FOR MORE DETAILS only serious buyers Contact No{' '}
              <span className="text-teal-950">0316/858/58/17</span>……FAST
            ...
            <div className="mt-4 space-y-4">
              <div>
                ...
                <p className="text-teal-950">
                  PTA approved | Dual SIM | Water pack
                </p>
                <p className="text-teal-950">
                  Storage: 12/128GB & 12/256GB both available
                </p>
              ...
              <div>
                ...
                <p className="text-teal-950">
                  6/128GB | Water pack | Brand new fresh
                </p>
              ...
              <div>
                ...
                <p className="text-teal-950">
                  12/128GB | Brand new fresh | Water pack
                </p>
                <p className="text-teal-950">Dual SIM approved</p>
            ...
            <p className="mt-4 font-semibold text-teal-950">
              ...
              <span className="text-teal-950">0316-8585/817</span> fast response
              on WhatsApp
            </p>
            <p className="mt-2 text-teal-950 font-semibold">
        ...
        <div className="w-full lg:w-2/3 border-slate-300 rounded-md bg-white">
          ...
          <div className="p-4 border border-slate-300 rounded-md mt-4">
            ...
            <p className="text-sm text-teal-950 flex items-center">
              <FontAwesomeIcon icon={faMapMarkerAlt} className="mr-2" /> Kacheri
              Road, Multan
            </p>
          </div>
