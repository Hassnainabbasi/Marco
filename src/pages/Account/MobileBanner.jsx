...
import { ArrowForward, ArrowForwardIos, Chat, Email, FlagOutlined, LocationOffOutlined, PhoneOutlined, Share } from '@mui/icons-material';
...
export default function MobileBanner() {
   ...
   <AccountCarousel />
    ...
    <div>
      <h1 className='font-bold text-teal-950 text-md mb-4'>Suzuki Every 2013</h1>
    </div>
...
just just buy or drive biometric on sport dealer hazrat sy sorry
          ...
          <h2 className="text-md mb-2 text-teal-950 font-bold">
            ...
            <div className="flex items-center mb-4">
              ...
              <div className="ml-4">
                ...
                <a className="text-teal-950 text-sm font-bold font-sans " href="#">
                  See profile
     ...
     <hr className='border border-gray-300'/>
       ...
       <div className='text-teal-950'>
        ...
        <button className='flex gap-2 text-sm'><LocationIcon />Punjab Coop Housing Society,Lahore</button>
      <div className='mt-5 text-sm flex items-center justify-between'>
        <button>AD ID 10987599457135</button>
        <button className='font-bold'><FlagOutlined /> Report this ad</button>
      </div>
      <div className="bg-white mt-8 mb-6 border p-4">
          <h2 className="text-md mb-2 text-teal-950 font-bold">
            ...
            <div className="flex items-center mb-4">
              ...
              />
              <div className="ml-1">
                <p className="text-sm font-bold text-teal-950 mt-2">Find the best Lubricant for your vechile</p>         
                </div>
                <div>
                <ArrowForwardIos fontSize="small" />  
                  </div>   
            </div>
            <button className='w-full py-2 bg-blue-600 text-white'>LEARN MORE</button>
     ...
     <hr className='border border-gray-300'/>
       ...
       <div className='w-full text-teal-950 overflow-x-auto'>
        ...
        <div className="min-w-[16rem] bg-white border border-gray-300 rounded-lg shadow-md ">
                            <img src="https://images.olx.com.pk/thumbnails/518749137-800x600.webp"
                            className="w-full h-32 object-cover" />
                            <div className="p-2">
                              <div className="flex justify-between items-center">
                              <span className="text-lg sm:text-base font-semibold text-teal-950">Rs 1,758,00</span>
                    <FontAwesomeIcon icon={HeartIcon} className="text-teal-950" />
                 
                              </div>
                              <h2 className="text-teal-950 text-lg sm:text-base font-semibold">Suzuki 2014</h2>
        ...
        <div className="min-w-[16rem] bg-white rounded-lg flex items-center justify-center">
          <div className='flex items-center'>
            <button className='text-blue-600 font-bold'>See All <ArrowForwardIos className='ml-1'/></button>
            </div>          
        </div>
        </div>
       </div>
       <div className='w-full mt-8 text-teal-950 overflow-x-auto'>
        ...
        <div className="min-w-[16rem] bg-white rounded-lg flex items-center justify-center">
         ...
         <div className='flex justify-center mt-6'>
          <img  src="https://tpc.googlesyndication.com/simgad/14976513286668588775" alt="" />
         </div>
    </div>
    <div className='py-5 '>
     <hr className='border border-gray-300'/>
     ...
     <hr className='border border-gray-300'/>
       ...
       <div className="flex space-x-2 bs-container justify-center">
            ...
            <button className='w-full border font-semibold border-teal-950 py-2 rounded-sm'><Email className='mr-2'/>Sms</button>
            <button className='w-full border font-semibold border-teal-950 py-2 rounded-sm'><PhoneOutlined className='mr-2'/>Call</button>
            <button className='w-full border border-teal-950 py-2 rounded-sm text-white bg-teal-950'><Chat className='mr-2'/>Chat</button>
            </div>
    </div>
  )
}
