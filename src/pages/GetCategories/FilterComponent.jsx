...
export default function FilterComponent({ setFilter }) {
        ...
        <div className="overflow-hidden">
          <div className="bg-gray-100 flex items-center justify-between gap-2 p-4">
            <div className="flex items-center gap-2">
              ...
              <button className="text-teal-950 text-xl font-bold">
                Filters
              </button>
            </div>
            <div className="">
              <button className="underline underline-offset-4 font-bold text-teal-950">
                Clear All
              </button>
            </div>
          </div>
          <div className="bs-container flex flex-col">
            <div className="py-3 text-teal-950 font-bold">Sort</div>
            <div className="flex gap-3 w-full overflow-x-scroll pb-2">
              <button className="border-2 text-xs px-2 whitespace-nowrap p-2 border-teal-600 bg-teal-100 text-teal-500 rounded-sm">
                New Listed
              </button>
              <button className="border text-xs px-2 whitespace-nowrap p-2 border-gray-600 rounded-sm">
                New Listed
              </button>
              <button className="border text-xs px-2 whitespace-nowrap p-2 border-gray-600 rounded-sm">
                New Listed
          ...
          <div className="bs-container">
            <div className="py-3 font-semibold text-teal-950">View</div>
  ...
  `}
          ...
          <div className="bs-container">
            <div className="font-bold text-teal-950 mb-3">IS DELIVERABLE</div>
            <div className="flex gap-2">
              <button className="p-3 px-5 border rounded-md border-teal-950 text-teal-950">
                Yes
              </button>
              <button className="p-3 px-5 border rounded-md border-teal-950 text-teal-950">
                Yes
          ...
          <div className="bs-container flex flex-col">
            <div className="py-3 text-teal-950 font-bold">Condition</div>
            <div className="flex gap-3 overflow-x-auto w-full pb-2">
              <button className="p-3 px-5 border rounded-md border-teal-950 whitespace-nowrap text-teal-950">
                New
              </button>
              <button className="p-3 px-5 border rounded-md border-teal-950 whitespace-nowrap text-teal-950">
                Used
              ...
              <button className="p-3  border rounded-md border-teal-950 whitespace-nowrap text-teal-950">
                Refurbished
              </button>
              <button className="p-3  border rounded-md border-teal-950 whitespace-nowrap text-teal-950">
          ...
          <div className="bs-container mb-5">
            <button className="bg-teal-950 p-4 rounded-md text-white w-full">
              Filter
            </button>
          </div>
        </div>
