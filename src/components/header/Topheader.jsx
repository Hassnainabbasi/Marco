    ...
    <div className="flex space-x-4 items-center mt-2 gap-2 ml-">
      ...
      <div className="flex space-x-6 items-center p-2">
        <div className="flex items-center space-x-2">
          <div className="bg-gradient-to-b from-gray-300 to-white rounded-full p-2">
            <svg
          ...
          <h1 className="text-base font-sans font-bold text-teal-950">Motors</h1>
        </div>

        <div className="flex items-center space-x-2">
          <div className="bg-gradient-to-b from-slate-300 to-white rounded-full p-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <h1 className="text-base font-sans font-bold text-teal-950">Property</h1>
        </div>
      </div>
    </div>
  )
